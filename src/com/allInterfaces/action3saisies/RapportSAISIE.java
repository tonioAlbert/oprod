    ...
    private void j_bouton_valider_rapport_saisiesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_j_bouton_valider_rapport_saisiesActionPerformed
        ...
        if(selected_region.equals(selectRegion)){
            ...
            //this.setAlwaysOnTop(true);
                        ...
                        traitements  = new Querry(this.BDD_HOST, this.BDD_PORT, this.BDD_DBNAME, this.BDD_PWD, this.BDD_USER, this.demarche).getRapportSAISIE(selected_region, Formats.ConvertOcfmToOcm(this.demarche));
