 ...
 * @author RAP
 */
public class RapportCfEditableParCommune extends javax.swing.JInternalFrame {
     ...
     */
    public RapportCfEditableParCommune(String HOST, Integer PORT, String DBNAME, String USER, String PWD, String dem) {
        ...
        this.j_bouton_exporter_rapport_cf_editable_par_commune.setEnabled(false);
    ...
    private void initComponents() {
        ...
        j_table_rapport_cf_editable_par_commune = new javax.swing.JTable();
        ...
        j_bouton_valider_rapport_cf_editable_par_commune = new javax.swing.JButton();
        j_bouton_exporter_rapport_cf_editable_par_commune = new javax.swing.JButton();

        setClosable(true);
        setIconifiable(true);
        setMaximizable(true);
        setResizable(true);
        setTitle("Rapport CF editable par Commune");
        ...
        j_table_rapport_cf_editable_par_commune.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        j_table_rapport_cf_editable_par_commune.setFont(new java.awt.Font("Arial Narrow", 0, 13)); // NOI18N
        j_table_rapport_cf_editable_par_commune.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Région", "District", "Commune", "CF éditable"
            }
        ) {
        ...
        jScrollPane1.setViewportView(j_table_rapport_cf_editable_par_commune);
        if (j_table_rapport_cf_editable_par_commune.getColumnModel().getColumnCount() > 0) {
            j_table_rapport_cf_editable_par_commune.getColumnModel().getColumn(3).setResizable(false);
        }
        ...
        j_bouton_valider_rapport_cf_editable_par_commune.setFont(new java.awt.Font("Arial Narrow", 1, 14)); // NOI18N
        j_bouton_valider_rapport_cf_editable_par_commune.setText("Valider");
        j_bouton_valider_rapport_cf_editable_par_commune.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        j_bouton_valider_rapport_cf_editable_par_commune.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                j_bouton_valider_rapport_cf_editable_par_communeActionPerformed(evt);
            }
        });

        j_bouton_exporter_rapport_cf_editable_par_commune.setFont(new java.awt.Font("Arial Narrow", 1, 14)); // NOI18N
        j_bouton_exporter_rapport_cf_editable_par_commune.setText("Exporter");
        j_bouton_exporter_rapport_cf_editable_par_commune.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        j_bouton_exporter_rapport_cf_editable_par_commune.setMaximumSize(new java.awt.Dimension(67, 33));
        j_bouton_exporter_rapport_cf_editable_par_commune.setMinimumSize(new java.awt.Dimension(67, 33));
        j_bouton_exporter_rapport_cf_editable_par_commune.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                j_bouton_exporter_rapport_cf_editable_par_communeActionPerformed(evt);
            }
        });
        ...
        j_panel_saisie_par_opLayout.setHorizontalGroup(
            ...
            .addGroup(j_panel_saisie_par_opLayout.createSequentialGroup()
                ...
                .addGroup(j_panel_saisie_par_opLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(j_bouton_valider_rapport_cf_editable_par_commune, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, j_panel_saisie_par_opLayout.createSequentialGroup()
                ...
                .addComponent(j_bouton_exporter_rapport_cf_editable_par_commune, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(348, 348, 348))
        );
            ...
            .addGroup(j_panel_saisie_par_opLayout.createSequentialGroup()
                .addGroup(j_panel_saisie_par_opLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(j_panel_saisie_par_opLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(j_bouton_valider_rapport_cf_editable_par_commune, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 302, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(j_bouton_exporter_rapport_cf_editable_par_commune, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void j_bouton_exporter_rapport_cf_editable_par_communeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_j_bouton_exporter_rapport_cf_editable_par_communeActionPerformed
        
        String[] TextEnTeteTableau = {"Région", "District", "Commune", "CF éditable : "+demarche};

        new Exports(BDD_HOST, BDD_PORT, BDD_DBNAME, BDD_PWD, BDD_USER, Formats.ConvertOcfmToOcm(demarche)).ExportTableToExcel(this.j_table_rapport_cf_editable_par_commune, "CF_editable",TextEnTeteTableau, "Export CF éditable par commune OK !");
         
    }//GEN-LAST:event_j_bouton_exporter_rapport_cf_editable_par_communeActionPerformed
    ...
    private void j_bouton_valider_rapport_cf_editable_par_communeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_j_bouton_valider_rapport_cf_editable_par_communeActionPerformed
        ...
        if(selected_region.equals(selectRegion)){
            ...
            //this.setAlwaysOnTop(true);
                        ...
                        if(traitements.size() <1){
                            ...
                            this.j_bouton_exporter_rapport_cf_editable_par_commune.setEnabled(true);
                        }
            
        }
        
    }//GEN-LAST:event_j_bouton_valider_rapport_cf_editable_par_communeActionPerformed
    ...
    private javax.swing.JButton j_bouton_exporter_rapport_cf_editable_par_commune;
    private javax.swing.JButton j_bouton_valider_rapport_cf_editable_par_commune;
    ...
    private javax.swing.JTable j_table_rapport_cf_editable_par_commune;
