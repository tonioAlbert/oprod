 ...
 * @author RAP
 */
public class VectorisationParCommune extends javax.swing.JInternalFrame {
     ...
     */
    public VectorisationParCommune(String HOST, Integer PORT, String DBNAME, String USER, String PWD, String dem) {
        ...
        this.j_bouton_exporter_rapport_vectorisation_par_commune.setEnabled(false);
    ...
    private void initComponents() {
        ...
        j_bouton_valider_vectorisation_par_commune = new javax.swing.JButton();
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Vectorisation Par Commune");
        ...
        j_bouton_valider_vectorisation_par_commune.setFont(new java.awt.Font("Arial Narrow", 1, 14)); // NOI18N
        j_bouton_valider_vectorisation_par_commune.setText("Valider");
        j_bouton_valider_vectorisation_par_commune.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        j_bouton_valider_vectorisation_par_commune.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                j_bouton_valider_vectorisation_par_communeActionPerformed(evt);
            }
        });
        ...
        j_panel_saisie_par_opLayout.setHorizontalGroup(
            ...
            .addGroup(j_panel_saisie_par_opLayout.createSequentialGroup()
                ...
                .addGroup(j_panel_saisie_par_opLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(j_bouton_valider_vectorisation_par_commune, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
            ...
            .addGroup(j_panel_saisie_par_opLayout.createSequentialGroup()
                .addGroup(j_panel_saisie_par_opLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(j_panel_saisie_par_opLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(j_bouton_valider_vectorisation_par_commune, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void j_bouton_valider_vectorisation_par_communeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_j_bouton_valider_vectorisation_par_communeActionPerformed
        ...
        if(selected_region.equals(selectRegion)){
            ...
            //this.setAlwaysOnTop(true);
                        ...
                        traitements  = new Querry(this.BDD_HOST, this.BDD_PORT, this.BDD_DBNAME, this.BDD_PWD, this.BDD_USER, this.demarche).getVectorisationParCommune(selected_region, Formats.ConvertOcfmToOcm(this.demarche));
                        ...
                        if(traitements.size() <1){
                            ...
                            JOptionPane.showMessageDialog(null, "Aucune vectorisation à été trouvé !","Aucun résultat trouvé", JOptionPane.INFORMATION_MESSAGE);
                            ...
                            this.j_bouton_exporter_rapport_vectorisation_par_commune.setEnabled(true);
                        }
            
        }
        
    }//GEN-LAST:event_j_bouton_valider_vectorisation_par_communeActionPerformed
    ...
    private javax.swing.JButton j_bouton_valider_vectorisation_par_commune;
